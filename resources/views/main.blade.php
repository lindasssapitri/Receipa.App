...
<head>
    ...
    <title>Recepia - Resep Dan Menu</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <!-- Masukkan font FontAwesome via CDN untuk icon pendukung navbar & card -->
    ...
    <style>
        ...
        body {
            ...
            background-color: #E28413; /* Warna dasar orange figma global */
        }
    </style>
</head>
<body class="min-h-screen text-gray-800">
    ...
    <header class="bg-white px-6 py-4 flex items-center justify-between shadow-md sticky top-0 z-50">
        ...
        <div class="flex items-center gap-6">
            <nav class="hidden md:flex items-center gap-6 text-xs tracking-wider">
                <a href="{{ route('resep.menu') }}" class="text-[#FF7A00] font-bold">Home</a>
    ...
    <main class="max-w-7xl mx-auto px-4 md:px-8 py-6 space-y-8">
        ...
        <div class="relative rounded-3xl overflow-hidden h-[320px] shadow-xl bg-cover bg-center flex items-center" style="background-image: linear-gradient(to right, rgba(0,0,0,0.75) 40%, rgba(0,0,0,0.2)), url('{{ asset('asetts/Images/iga_bakar.jpg') }}');">
            <div class="p-8 md:p-12 text-white max-w-xl space-y-2">
                ...
                <!-- Slide Dots Indicator & Arrows Mockup -->
        ...
        <!-- 4. GRID CONTAINER: RESEP UTAMA (8 CARD FIRST SECTION) -->
        ...
        <!-- 5. GRID CONTAINER: REKOMENDASI RESEP HARI INI (8 CARD SECOND SECTION) -->
        <section class="space-y-4 pt-4">
            <h2 class="text-lg md:text-xl font-black text-gray-900 tracking-wide">Rekomendasi Resep Hari ini</h2>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                @php
                    $rekomendasi = [
        ...
        <!-- Button Lihat Resep Lainnya (Gausah difungsiin) -->
        <div class="flex justify-center pt-4">
            <button class="bg-[#C84B24] hover:bg-[#b03f1b] text-white text-xs md:text-sm font-bold py-3.5 px-12 rounded-xl shadow-md transition">
                Lihat Resep Lainnya
            </button>
        </div>
    ...
    <footer class="bg-white mt-16 pt-12 pb-6 px-6 md:px-12 border-t border-gray-200">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-gray-200 text-xs text-gray-500 leading-relaxed">
            ...
            <!-- Kolom Tengah: Download App Mockup Buttons -->
            ...
            <div class="space-y-3">
                ...
                <div class="flex rounded-lg overflow-hidden border border-gray-300 max-w-sm">
                    ...
                    <button class="bg-[#28A745] hover:bg-green-600 text-white font-bold px-4 transition">
                        Subscribe
                    </button>
                </div>
            </div>
        ...
        <!-- Baris Paling Bawah: Social Media Icons -->
